(function () {
    ...
    SimpleJsonp.prototype = {
        /**
         * Get call to the Etsy API.
         * @param options object
         * {
		 *   path: string Path based on API
		 *      i.e /listings/:listing_id (listing_id will be replaced with param.listing_id correctly)
		 *   params: object Url params specified by docs
		 *   callbackName: string custom jsonp callback name
		 *   timeout: int Integer greater than 0 that overrides the default request timeout
        ...
        /***
         * Internal request function used by get, not to be called outside
         * @param options object
         * {
		 *   path: string Path based on API
		 *      i.e /listings/:listing_id (listing_id will be replaced with param.listing_id correctly)
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        window['SimpleJsonp'] = SimpleJsonp;
    }
})();